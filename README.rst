...
You can configure what the application does by copying ``webhooks_config.py``
and customizing its contents.
Later, run ``WEBHOOKS_CONFIG=myconfig.py python webhooks.py``
